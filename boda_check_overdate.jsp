...
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="../css/boda_check_overdate.css">
<script src="https://kit.fontawesome.com/4849ba1eab.js" crossorigin="anonymous"></script>
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR&display=swap" rel="stylesheet">
<script src="../js/boda_check_overdate.js" defer></script>
  ...
  <nav class="navbar2">
	...
	<aside class="boda_mypage_menu">
		<table class="mypage_menu" border>
      		...
      		<tr><td><a href="boda_check_overdate.jsp" scope="col" id="select_menu">연체일 확인</a></td></tr>
      		<tr><td><a href="#" scope="col">희망도서 신청</a></td></tr>
      	</table>
	</aside>
	<section class="boda_check_overdate">
      <div class="content_direction">
      	<a id="main_content_title"><b>연체일확인</b></a>
...
<%
	...
	ArrayList<bodaCheckOverdate> clist = dao.checkOverdate("easy@naver.com");
	
%>
      <table class="main_content">
      <thead><tr><td class="main_content_th" ><b>번호</b></td>
          <td class="main_content_th" colspan="3"><b>도서이름</b></th>
          <td class="main_content_th" colspan="2"><b>대출일</b></th>
          <td class="main_content_th" colspan="2"><b>반납예정일</b></th>
          <td class="main_content_th"><b>연체일</b></td>
        </tr></thead>
      <tbody>
      <tr>
      <%int cnt=clist.size(); %>
       <%for(bodaCheckOverdate c : clist){ %>
      <td><%=cnt %></td>
         <td colspan="3"><%=c.getBookName() %></td>
         <td colspan="2"><%=c.getRentDate() %></td>
         <td colspan="2"><%=c.getDueDate() %></td>
         <td><%=c.getOverdate() %></td>
         </tr>
         <%cnt--; %>
      	 <%} %>
